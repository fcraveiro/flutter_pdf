...
class PdfInvoiceApi {
//  var dataFont = rootBundle.load("assets/fonts/RoadRage-Regular.ttf");
//    var myFont = pw.Font.ttf(dataFont);
// Uint8List fontData = File('assets/fonts/RoadRage-Regular.ttf').readAsBytesSync();
  ...
  static Future<File> generate(Invoice invoice) async {
    final pdf = Document(
      theme: ThemeData.withFont(
        ...
        italic:
            Font.ttf(await rootBundle.load("assets/fonts/Roboto-Italic.ttf")),
        boldItalic: Font.ttf(
